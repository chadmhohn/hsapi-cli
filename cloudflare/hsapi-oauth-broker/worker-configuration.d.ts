/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5c205315d3529b6f7e1362939ae19ca)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	AUTH_RATE_LIMITER: RateLimit;
	ENVIRONMENT: "staging" | "production" | "local";
	HUBSPOT_ACCOUNT_ID: "246523489" | "REPLACE_ACCOUNT_ID";
	HUBSPOT_CLIENT_ID: "3930f35a-b323-4fc3-a4ba-5a528cb1b289" | "00000000-0000-4000-8000-000000000001";
	HUBSPOT_REDIRECT_URI: "https://hsapi-oauth-broker-staging.chad-m-hohn.workers.dev/v1/oauth/callback" | "https://hsapi-oauth-broker-production.REPLACE.workers.dev/v1/oauth/callback" | "http://localhost:8787/v1/oauth/callback";
	...
	BROKER_SESSION_START_KEY: string;
	OAUTH_SESSIONS: DurableObjectNamespace<import("./src/index").OAuthSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OAuthSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HUBSPOT_ACCOUNT_ID" | "HUBSPOT_CLIENT_ID" | "HUBSPOT_REDIRECT_URI" | "HUBSPOT_REQUIRED_SCOPES" | "HUBSPOT_OPTIONAL_SCOPES" | "HUBSPOT_CLIENT_SECRET" | "BROKER_SIGNING_KEY" | "BROKER_SESSION_START_KEY">> {}
}
