...
test('11 Issue #17 (slice 1): catalog argspecs + hsapi help + per-command --help', async () => {
...

    {
      ...
      for (const moduleName of ['runtime', 'flags', 'output', 'history', 'command-inputs', 'usage', 'catalog', 'auth', 'config-paths', 'tiers', 'auth-resolvers', 'request', 'crm-object-types', 'commands/index']) {
